...
public class PointsController {
    ...
    public void deletePoints(@RequestParam int position_id) {
    ...
    public Points[] findByPid(@RequestParam int pid) {
        logger.info("根据PID {} 查询地点", pid);
        return pointsService.findByPid(pid);
    }

    @RequestMapping("/findByPosition_id")
    public Points findByPosition_id(@RequestParam int position_id) {
        logger.info("根据位置ID {} 查询地点", position_id);
        return pointsService.findByPosition_id(position_id);
    }

    @RequestMapping("/insert")
    public Points insertPoints(@RequestBody Points points) {
    ...
    public void updatePoints(@RequestBody Points points) {
